...
type Forms struct {
	...
	Codeforces string `protobuf:"bytes,3,opt,name=codeforces,proto3" json:"codeforces,omitempty"` //用户cf账户id
	Key        string `protobuf:"bytes,4,opt,name=key,proto3" json:"key,omitempty"`               //用户的key
	Secret     string `protobuf:"bytes,5,opt,name=secret,proto3" json:"secret,omitempty"`         //用户的secret
}
...
func (x *Forms) GetCodeforces() string {
	if x != nil {
		return x.Codeforces
	}
	return ""
...
var file_form_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x66, 0x6f, 0x72, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x6e, 0x6f,
	0x74, 0x65, 0x70, 0x61, 0x64, 0x2e, 0x63, 0x66, 0x22, 0x7d, 0x0a, 0x05, 0x66, 0x6f, 0x72, 0x6d,
	...
	0x0a, 0x63, 0x6f, 0x64, 0x65, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x63, 0x6f, 0x64, 0x65, 0x66, 0x6f, 0x72, 0x63, 0x65, 0x73, 0x12, 0x10, 0x0a,
	...
	0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x42, 0x03, 0x5a, 0x01, 0x2e, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_form_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_form_proto_goTypes = []interface{}{
	(*Forms)(nil), // 0: notepad.cf.forms
}
